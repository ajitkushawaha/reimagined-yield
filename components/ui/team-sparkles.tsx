...
interface TeamSparklesProps {
  title: string;
  subtitle?: string;
  className?: string;
}

export default function TeamSparkles({ title, subtitle, className = "" }: TeamSparklesProps) {
  return (
    <div className={`w-full bg-black flex flex-col items-center justify-center overflow-hidden rounded-md relative ${className}`}>
